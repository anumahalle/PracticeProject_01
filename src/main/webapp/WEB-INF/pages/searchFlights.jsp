...
<link rel="stylesheet"
	href="<c:url value='css/newstyle.css'/>" type="text/css"
	media="all">
...
<link rel="stylesheet"
	href="<c:url value='css/datatable-bootstrap.min.css'/>" type="text/css"
	media="all">
...
<body >
	...
	<form:form method="GET" action="searchFlights">
		<!-- SEARCH -->
